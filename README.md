...
where **X**ⱼ in ℝ³ is a reconstructed 3D point, **x**ᵢⱼ in ℝ² is its observation in image *i*, **K**ᵢ is the camera intrinsic matrix, and **R**ᵢ, **t**ᵢ are the camera pose (rotation and translation).
